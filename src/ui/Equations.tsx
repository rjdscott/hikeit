  ...
  return (
    <div>
      ...
      <div className="eq-grid">
        ...
        <Eq cap={`Apparent wind from true wind ${fmt(d.wind.tws, 1)} kn at ${fmt(d.wind.twa, 0)}° and boat speed ${fmt(d.wind.bsp, 1)} kn (${d.bspSrc === 'card' ? 'target card' : 'polar'}). Heeling coefficient from lift and drag at the apparent wind angle β; flat = ${fmt(d.flat, 2)} scales lift${b.chScale !== 1 ? `; k_H = ${fmt(b.chScale, 2)} is the Advanced scale` : ''}.`}
